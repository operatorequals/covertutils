# -*- coding: utf-8 -*-
#
# CovertUtils documentation build configuration file, created by
...
htmlhelp_basename = 'CovertUtilsdoc'
...
latex_documents = [
    (master_doc, 'CovertUtils.tex', u'CovertUtils Documentation',
     u'Author', 'manual'),
]
